...
<aside class="notes">
* The same chart, but with the different versions of the code coloured in
* Each version of the code had slightly different rules/code
* Each "version" was ~200 code files with various logic for data cleaning, calculations, test suites etc
