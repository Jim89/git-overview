...
* Create a repository in the project you're working in
* (Or File > New > Create Remote Repository in SourceTree if you linked to BitBucket)
* Get the (HTTPS) URL to clone in your repository (or click "Clone in SourceTree")
...
* Clone the test repo in my project area on BitBucket
</aside>
