...
* SourceTree > Branches _or_ Remotes > Look! `r emo::ji('eyes')`
...
* After creating a local branch:
    * SourceTree > Push > Select the new branch
    * `git push -u origin [branch name]` - push the branch to the remote (`origin`)
* To get a remote branch:
    * SourceTree > Fetch > Expand remote (`origin`) > Right click on branch > Checkout
    * `git fetch` and then `git checkout [new branch name]`
...
* Local:
    * SourceTree > Right-click on branch > Delete
    * `git branch -d [branch name]`
* Remote    
    * SourceTree > Expand remote > Right click on branch > Delete
    * `git push origin --delete [branch name]`


<aside class="notes">
* Take care deleting branches, can be tricky 
